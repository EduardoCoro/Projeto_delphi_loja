...
begin
  ...
  begin
    EnviaMensagem('Nenhum registro adicionado!','Informação...', mtInformation, [mbOK]);
    if edCodCliente.CanFocus then
      edCodCliente.SetFocus;
    exit;
  end;
...
begin
  ...
  if edDataFim.Date > date() then
  begin
    EnviaMensagem('Data maior que a atual!','Atenção...',mtInformation,[mbOK]);
    edDataFim.Clear;
    exit;
  end;
end;
...
procedure TTFiltroRelCompModel.FormShow(Sender: TObject);
begin
