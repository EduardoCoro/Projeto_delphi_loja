...
begin
  ...
  begin
    EnviaMensagem('É necessário informar a Data Inicial para continuar!', 'Informação...', mtInformation, [mbOK]);
  ...
  begin
    EnviaMensagem('É necessário informar a Data Final para continuar!', 'Informação...', mtInformation, [mbOK]);
  ...
  begin
    EnviaMensagem('A Data Inicial deve ser menor ou igual a Data Final!', 'Informação...', mtInformation, [mbOK]);
    if DateEditIni.CanFocus then
      DateEditIni.SetFocus
  end
  else
...
function GetCondicao(var tag: Integer ):string; // FUNÇÃO P/ PEGAR A SINTAXE DE ACORDO COM O QUE USUÁRIO PREENCHEU
  var aux : string;
begin
  if tag = 0 then
  begin
