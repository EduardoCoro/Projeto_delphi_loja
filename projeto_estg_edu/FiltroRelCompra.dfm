object TFiltroRelCompraCli: TTFiltroRelCompraCli
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Filtro de Relat'#243'rio de Compra'
  ClientHeight = 303
  ClientWidth = 460
  Color = clBtnFace
  ...
  object FiltroRelCliente: TPanel
    ...
    ParentBackground = False
    TabOrder = 0
    object rdOrdemgraf: TRadioGroup
      Left = 1
      Top = 206
      Width = 458
      Height = 40
      Margins.Top = 5
      Align = alTop
      Caption = 'Ordenar Gr'#225'fico por...'
      Color = 15329769
      Columns = 4
      ItemIndex = 0
      Items.Strings = (
    ...
    object groupCliente: TGroupBox
      ...
      Align = alTop
      Caption = 
        'Selecionar por filtrar Cliente ou Todos Campo vazio {  F3 - Pesq' +
        'uisar, F6 - Limpar }'
      Color = 15329769
      ParentBackground = False
      ParentColor = False
