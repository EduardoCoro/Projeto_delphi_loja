...
begin
  ...
  //Cliente
   ini.WriteBool('Cliente','rellist', ckbClilist.Checked);
   ini.WriteBool('Cliente','reltop', ckbClitop.Checked);
  //Produto
   ini.WriteBool('Produto','rellist', ckbprodlist.Checked);
   ini.WriteBool('Produto','reltop', ckbProdtop.Checked);
   ini.WriteBool('Produto','relestoque', ckbprodrestoque.Checked);
  //fornecedor
   ini.WriteBool('Fornecedor','rellist', ckbforlist.Checked);
   ini.WriteBool('Fornecedor','reltop', ckbfortop.Checked);
   ini.WriteBool('Fornecedor','relforprod ', ckbForneprod.Checked);
