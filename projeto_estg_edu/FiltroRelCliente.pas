...
uses
  RelCliente, RelClienteS, GraficoCliente, GraficoListCliente;
...
begin
  case rgTipoRel.ItemIndex of
    0: TRelCliente.chamatela(rgFiltro.ItemIndex, rgOrdem.ItemIndex); // Analítico
    1: TRelClienteS.Chamatela; // Sintético
    2: TGraficoListCliente.Chamatela; // Gráfico
  end;
end;
