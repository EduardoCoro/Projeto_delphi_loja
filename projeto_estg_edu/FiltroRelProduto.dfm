object TFiltroRelProduto: TTFiltroRelProduto
  Left = 0
  Top = 0
  ...
  BorderWidth = 3
  Caption = 'Filtro do Relat'#243'rio de Produto'
  ClientHeight = 309
  ClientWidth = 525
  Color = clWhite
  ...
  object FiltroRelCliente: TPanel
    ...
    object rgSemValidade: TRadioGroup
      Left = 1
      Top = 159
      Width = 523
      Height = 40
      Align = alTop
      Caption = 'Produto est'#225' ....'
      Color = 15329769
      Columns = 3
      ItemIndex = 0
      Items.Strings = (
    ...
    object gFornecedor: TGroupBox
      ...
      Align = alTop
      Caption = 
        'Buscar um Forncedor ou para Todos campo vazio <F3 p/ Pesquisar -' +
        ' F6 p/ Limpar >'
      Color = 15329769
      ParentBackground = False
      ParentColor = False
