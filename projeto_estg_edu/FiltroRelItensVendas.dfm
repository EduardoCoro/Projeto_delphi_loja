object TFiltroRelItensVendas: TTFiltroRelItensVendas
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Filtro de Relat'#243'rios de itens Vendas'
  ClientHeight = 184
  ClientWidth = 569
  Color = cl3DLight
  ...
  object FiltroRelCliente: TPanel
    ...
    object GroupBox2: TGroupBox
      ...
      Height = 59
      Align = alTop
      Caption = 'Selecionar por filtrar Cliente..'
      Color = 15329769
      ParentBackground = False
      ParentColor = False
      TabOrder = 0
      ...
      object edCodCompra: TEdit
        ...
        NumbersOnly = True
        TabOrder = 0
        OnKeyDown = edCodCompraKeyDown
        OnKeyPress = edCodCompraKeyPress
      end
    end
  end
end
