...
uses
  ...
  Dialogs, StdCtrls, Buttons, rxToolEdit, rxCurrEdit, Mask, IniFiles, ExtCtrls;
...
begin
  ...
  // Leitura
  if ArquivoINI.ReadBool('Produto','val', ProdValidade ) = True then
  begin
    gpValidade.Visible := False;
  end;
end;
...
begin
  ...
  //validade
  if gpValidade.Visible <> False then
  ...
  begin
    case AcaoTela[1] of
      ...
      begin
        ...
        xCodProduto := GetCodigoIdentity('PRODUTO');
