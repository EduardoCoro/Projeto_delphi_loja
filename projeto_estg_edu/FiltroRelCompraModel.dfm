object TFiltroRelCompModel: TTFiltroRelCompModel
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'Filtro de Relat'#243'rio de Compra modelo de Venda detalhada'
  ClientHeight = 421
  ClientWidth = 634
  Color = clBtnFace
  ...
  object FiltroRelCliente: TPanel
    ...
    object GroupBox2: TGroupBox
      ...
      Anchors = []
      Caption = 
        'Selecionar para adicionar Cliente ou para todos lista vazia {  F' +
